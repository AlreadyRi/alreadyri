! function() {
    ...
    e.prototype = {
        ...
        mute: function(e) {
            var n = this || t;
            n.ctx || d(), n._muted = e, n.usingWebAudio && (n.masterGain.gain.value = e ? 0 : n._volume);
            for (var o = 0; o < n._howls.length; o++)
                if (!n._howls[o]._webAudio)
                    for (var r = n._howls[o]._getSoundIds(), i = 0; i < r.length; i++) {
                        var a = n._howls[o]._soundById(r[i]);
        ...
        _setup: function() {
            var e = this || t;
            if (e._initSuspended && e.ctx && "suspended" != e.ctx.state && (e._initSuspended = !1), e.state = e.ctx && !e._initSuspended ? e.ctx.state || "running" : "running", e._autoSuspend(), !e.usingWebAudio)
                if ("undefined" != typeof Audio) try {
                    void 0 === (n = new Audio).oncanplaythrough && (e._canPlayEvent = "canplay")
                } catch (t) {
                    e.noAudio = !0
                } else e.noAudio = !0;
            try {
    ...
    n.prototype = {
        ...
        load: function() {
            ...
            if (t.noAudio) e._emit("loaderror", null, "No audio support.");
                ...
                for (var r = 0; r < e._src.length; r++) {
                    ...
                    if (e._format && e._format[r]) a = e._format[r];
                        ...
                        if ("string" != typeof(u = e._src[r])) {
                            ...
                            continue
                        }(a = /^data:audio\/([^;,]+);/i.exec(u)) || (a = /\.([^.]+)$/.exec(u.split("?", 1)[0])), a && (a = a[1].toLowerCase())
                    }
                ...
                if (n) return e._src = n, e._state = "loading", "https:" === window.location.protocol && "http:" === n.slice(0, 5) && (e._html5 = !0, e._webAudio = !1), new o(e), e._webAudio && i(e), e;
        ...
        play: function(e, n) {
            ...
            if (r && !u._paused) return n || setTimeout(function() {
                o._emit("play", u._id)
            }, 0), u._id;
            ...
            u._paused = !1, u._ended = !1, u._sprite = e, u._seek = d, u._start = o._sprite[e][0] / 1e3, u._stop = (o._sprite[e][0] + o._sprite[e][1]) / 1e3, u._loop = !(!u._loop && !o._sprite[e][2]);
            var c = u._node;
            if (o._webAudio) {
                var f = function() {
                    o._refreshBuffer(u);
                    var e = u._muted || o._muted ? 0 : u._volume;
                    c.gain.setValueAtTime(e, t.ctx.currentTime), u._playStart = t.ctx.currentTime, void 0 === c.bufferSource.start ? u._loop ? c.bufferSource.noteGrainOn(0, d, 86400) : c.bufferSource.noteGrainOn(0, d, _) : u._loop ? c.bufferSource.start(0, d, 86400) : c.bufferSource.start(0, d, _), l !== 1 / 0 && (o._endTimers[u._id] = setTimeout(o._ended.bind(o, u), l)), n || setTimeout(function() {
                        o._emit("play", u._id)
                    }, 0)
                };
                "running" === t.state ? f() : (o.once("resume", f), o._clearTimer(u._id))
            } else {
                var p = function() {
                        c.currentTime = d, c.muted = u._muted || o._muted || t._muted || c.muted, c.volume = u._volume * t.volume(), c.playbackRate = u._rate;
                        try {
                            if (c.play(), c.paused) return void o._emit("playerror", u._id, "Playback was unable to start. This is most commonly an issue on mobile devices where playback was not within a user interaction.");
                            l !== 1 / 0 && (o._endTimers[u._id] = setTimeout(o._ended.bind(o, u), l)), n || o._emit("play", u._id)
                        } catch (e) {
                            o._emit("playerror", u._id, e)
                        }
                    },
                    h = window && window.ejecta || !c.readyState && t._navigator.isCocoonJS;
                if (4 === c.readyState || h) p();
                else {
                    var m = function() {
                        p(), c.removeEventListener(t._canPlayEvent, m, !1)
                    };
                    c.addEventListener(t._canPlayEvent, m, !1), o._clearTimer(u._id)
                }
            }
            return u._id
        },
        ...
        mute: function(e, n) {
            ...
            for (var r = o._getSoundIds(n), i = 0; i < r.length; i++) {
                ...
                a && (a._muted = e, o._webAudio && a._node ? a._node.gain.setValueAtTime(e ? 0 : a._volume, t.ctx.currentTime) : a._node && (a._node.muted = !!t._muted || e), o._emit("mute", a._id))
            }
            return o
        },
        volume: function() {
            ...
            var i;
            if (!(void 0 !== e && e >= 0 && e <= 1)) return (i = n ? o._soundById(n) : o._sounds[0]) ? i._volume : 0;
            if ("loaded" !== o._state) return o._queue.push({
                event: "volume",
                action: function() {
                    o.volume.apply(o, r)
            ...
            for (var a = 0; a < n.length; a++)(i = o._soundById(n[a])) && (i._volume = e, r[2] || o._stopFade(n[a]), o._webAudio && i._node && !i._muted ? i._node.gain.setValueAtTime(e, t.ctx.currentTime) : i._node && !i._muted && (i._node.volume = e * t.volume()), o._emit("volume", i._id));
            return o
        },
        ...
        _startFadeInterval: function(e, t, n, o, r, i) {
            var a = this,
                ...
                d = Math.abs(t - n) / .01,
                _ = d > 0 ? o / d : o;
            _ < 4 && (d = Math.ceil(d / (4 / _)), _ = 4), e._interval = setInterval(function() {
                d > 0 && (u += "in" === s ? .01 : -.01), u = Math.max(0, u), u = Math.min(1, u), u = Math.round(100 * u) / 100, a._webAudio ? e._volume = u : a.volume(u, e._id, !0), i && (a._volume = u), (n < t && u <= n || n > t && u >= n) && (clearInterval(e._interval), e._interval = null, a.volume(n, e._id), a._emit("fade", e._id))
            }, _)
        },
        _stopFade: function(e) {
            var n = this._soundById(e);
            return n && n._interval && (this._webAudio && n._node.gain.cancelScheduledValues(t.ctx.currentTime), clearInterval(n._interval), n._interval = null, this._emit("fade", e)), this
        },
        loop: function() {
        ...
        rate: function() {
            ...
            var i;
            if ("number" != typeof e) return (i = o._soundById(n)) ? i._rate : o._rate;
            if ("loaded" !== o._state) return o._queue.push({
                event: "rate",
                action: function() {
                    o.rate.apply(o, r)
            ...
            for (var a = 0; a < n.length; a++)
                if (i = o._soundById(n[a])) {
                    i._rateSeek = o.seek(n[a]), i._playStart = o._webAudio ? t.ctx.currentTime : i._playStart, i._rate = e, o._webAudio && i._node && i._node.bufferSource ? i._node.bufferSource.playbackRate.value = e : i._node && (i._node.playbackRate = e);
                    var u = o.seek(n[a]),
                        s = 1e3 * ((o._sprite[i._sprite][0] + o._sprite[i._sprite][1]) / 1e3 - u) / Math.abs(i._rate);
                    !o._endTimers[n[a]] && i._paused || (o._clearTimer(n[a]), o._endTimers[n[a]] = setTimeout(o._ended.bind(o, i), s)), o._emit("rate", i._id)
                }
            return o
        },
        seek: function() {
                ...
                if (!("number" == typeof e && e >= 0)) {
                    if (o._webAudio) {
                        var a = o.playing(n) ? t.ctx.currentTime - i._playStart : 0,
                            u = i._rateSeek ? i._rateSeek - i._seek : 0;
                        return i._seek + (u + a * Math.abs(i._rate))
                    }
                    return i._node.currentTime
                }
                var s = o.playing(n);
                s && o.pause(n, !0), i._seek = e, i._ended = !1, o._clearTimer(n), s && o.play(n, !0), !o._webAudio && i._node && (i._node.currentTime = e), o._emit("seek", n)
            }
            return o
        },
        playing: function(e) {
        ...
        unload: function() {
            for (var e = this, n = e._sounds, o = 0; o < n.length; o++) {
                if (n[o]._paused || e.stop(n[o]._id), !e._webAudio) {
                    /MSIE |Trident\//.test(t._navigator && t._navigator.userAgent) || (n[o]._node.src = "data:audio/wav;base64,UklGRigAAABXQVZFZm10IBIAAAABAAEARKwAAIhYAQACABAAAABkYXRhAgAAAAEA"), n[o]._node.removeEventListener("error", n[o]._errorFn, !1), n[o]._node.removeEventListener(t._canPlayEvent, n[o]._loadFn, !1)
                }
        ...
        _ended: function(e) {
            var n = e._sprite;
            if (!this._webAudio && e._node && !e._node.paused && !e._node.ended) return setTimeout(this._ended.bind(this, e), 100), this;
        ...
        _refreshBuffer: function(e) {
            return e._node.bufferSource = t.ctx.createBufferSource(), e._node.bufferSource.buffer = r[this._src], e._panner ? e._node.bufferSource.connect(e._panner) : e._node.bufferSource.connect(e._node), e._node.bufferSource.loop = e._loop, e._loop && (e._node.bufferSource.loopStart = e._start || 0, e._node.bufferSource.loopEnd = e._stop), e._node.bufferSource.playbackRate.value = e._rate, this
        },
    ...
    var r = {},
        i = function(e) {
            var t = e._src;
            if (r[t]) return e._duration = r[t].duration, void s(e);
            if (/^data:[^;]+;base64,/.test(t)) {
                ...
                d.open("GET", t, !0), d.withCredentials = e._xhrWithCredentials, d.responseType = "arraybuffer", d.onload = function() {
                    var t = (d.status + "")[0];
                    "0" === t || "2" === t || "3" === t ? u(d.response, e) : e._emit("loaderror", null, "Failed loading audio file with status: " + d.status + ".")
                }, d.onerror = function() {
        ...
        u = function(e, n) {
            t.ctx.decodeAudioData(e, function(e) {
                e && n._sounds.length > 0 && (r[n._src] = e, s(n, e))
            }, function() {
        ...
        d = function() {
            ...
            t._initSuspended = void 0 !== t.ctx && t.ctx && null != t.ctx.state && "suspended" === t.ctx.state;
...
! function() {
    ...
    HowlerGlobal.prototype._pos = [0, 0, 0], HowlerGlobal.prototype._orientation = [0, 0, -1, 0, 1, 0], HowlerGlobal.prototype.stereo = function(n) {
    ...
    }, HowlerGlobal.prototype.orientation = function(n, e, t, o, r, i) {
        if (!this.ctx || !this.ctx.listener) return this;
        var a = this._orientation;
        return e = "number" != typeof e ? a[1] : e, t = "number" != typeof t ? a[2] : t, o = "number" != typeof o ? a[3] : o, r = "number" != typeof r ? a[4] : r, i = "number" != typeof i ? a[5] : i, "number" != typeof n ? a : (this._orientation = [n, e, t, o, r, i], this.ctx.listener.setOrientation(n, e, t, o, r, i), this)
        ...
        for (var i = o._getSoundIds(t), a = 0; a < i.length; a++) {
            ...
            if (p) {
                ...
                p._stereo = e, p._pos = [e, 0, 0], p._node && (p._pannerAttr.panningModel = "equalpower", p._panner && p._panner.pan || n(p, r), "spatial" === r ? p._panner.setPosition(e, 0, 0) : p._panner.pan.value = e), o._emit("stereo", p._id)
            }
        }
        return o
        ...
        if (t = "number" != typeof t ? i._orientation[1] : t, o = "number" != typeof o ? i._orientation[2] : o, void 0 === r) {
        ...
        for (var a = i._getSoundIds(r), p = 0; p < a.length; p++) {
            ...
            if (s) {
                ...
                s._orientation = [e, t, o], s._node && (s._panner || (s._pos || (s._pos = i._pos || [0, 0, -.5]), n(s, "spatial")), s._panner.setOrientation(e, t, o)), i._emit("orientation", s._id)
            }
        }
        return i
        ...
        if (1 === i.length) {
            if ("object" != typeof i[0]) return (o = r._soundById(parseInt(i[0], 10))) ? o._pannerAttr : r._pannerAttr;
